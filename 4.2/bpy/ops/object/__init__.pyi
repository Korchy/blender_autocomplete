...
def convert(
    ...
    undo: bool | None = None,
    *,
    target: typing.Literal["CURVE", "MESH", "GPENCIL", "CURVES"] | None = "MESH",
    ...
    Curves -- Curves from evaluated curve data.
        :type target: typing.Literal['CURVE','MESH','GPENCIL','CURVES'] | None
...
def gpencil_modifier_add(
    ...
    undo: bool | None = None,
    *,
    type: bpy.typing.ObjectGreasepencilModifierTypeItems | None = "GP_THICK",
):
    ...
    :type undo: bool | None
    :param type: Type
    :type type: bpy.typing.ObjectGreasepencilModifierTypeItems | None
    """
