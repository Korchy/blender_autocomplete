...
def glClipPlane(plane: typing.Union[str, int], equation: 'bpy.context.object'):
...
def glCopyTexImage2D(target: typing.Union[str, int], level: int,
                     internalformat: int, x, y, width: int, height: int,
                     border: int):
...
def glEvalMesh(mode: typing.Union[str, int], i1, i2):
...
def glReadPixels(x, y, width, height, format: typing.Union[str, int],
                 type: typing.Union[str, int], pixels: 'bpy.context.object'):
