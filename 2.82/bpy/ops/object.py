...
def align(bb_quality: bool = True,
          ...
          align_axis: typing.Set[typing.Union[str, int]] = {}):
    '''Align Objects 
    ...
    :type align_axis: typing.Set[typing.Union[str, int]]
    '''
...
def bake(type: typing.Union[str, int] = 'COMBINED',
         pass_filter: typing.Set[typing.Union[str, int]] = {},
         filepath: str = "",
         width: int = 512,
         height: int = 512,
         margin: int = 16,
    ...
    :type pass_filter: typing.Set[typing.Union[str, int]]
...
def make_override_library(object: typing.Union[str, int] = 'DEFAULT'):
...
def mode_set_with_submode(
        ...
        toggle: bool = False,
        mesh_select_mode: typing.Set[typing.Union[str, int]] = {}):
    '''Sets the object interaction mode 
    ...
    :param toggle: Toggle 
    :type toggle: bool
    :param mesh_select_mode: Mesh ModeVERT Vertex, Vertex selection mode.EDGE Edge, Edge selection mode.FACE Face, Face selection mode. 
    :type mesh_select_mode: typing.Set[typing.Union[str, int]]
    '''
...
def modifier_apply(apply_as: typing.Union[str, int] = 'DATA',
                   modifier: str = ""):
    '''Apply modifier and remove from the stack 
...
def proxy_make(object: typing.Union[str, int] = 'DEFAULT'):
...
def quadriflow_remesh(use_paint_symmetry: bool = True,
    ...
    :param mode: Mode, How to specify the amount of detail for the new meshRATIO Ratio, Specify target number of faces relative to the current mesh.EDGE Edge Length, Input target edge length in the new mesh.FACES Faces, Input target number of faces in the new mesh. 
    :type mode: typing.Union[str, int]
