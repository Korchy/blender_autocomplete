...
def bevel(offset_type: typing.Union[str, int] = 'OFFSET',
    ...
    :param vmesh_method: Vertex Mesh Method, The method to use to create meshes at intersectionsADJ Grid Fill, Default patterned fill.CUTOFF Cutoff, A cut-off at each profile’s end before the intersection. 
...
def dissolve_limited(angle_limit: float = 0.0872665,
                     ...
                     delimit: typing.Set[typing.Union[str, int]] = {'NORMAL'}):
    ...
    :type delimit: typing.Set[typing.Union[str, int]]
    '''
...
def select_linked(delimit: typing.Set[typing.Union[str, int]] = {'SEAM'}):
...
def select_linked_pick(deselect: bool = False,
                       delimit: typing.Set[typing.Union[str, int]] = {'SEAM'},
                       index=-1):
...
def select_mirror(axis: typing.Set[typing.Union[str, int]] = {'X'},
                  extend: bool = False):
    '''Select mesh items at mirrored locations 

    :param axis: Axis 
    :type axis: typing.Set[typing.Union[str, int]]
...
def sort_elements(type: typing.Union[str, int] = 'VIEW_ZAXIS',
                  elements: typing.Set[typing.Union[str, int]] = {'VERT'},
                  reverse: bool = False,
                  seed: int = 0):
    ...
    :type elements: typing.Set[typing.Union[str, int]]
