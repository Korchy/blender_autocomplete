...
def decimate(mode: typing.Union[str, int] = 'RATIO',
    ...
    :param mode: Mode, Which mode to use for decimationRATIO Ratio, Use a percentage to specify how many keyframes you want to remove.ERROR Error Margin, Use an error margin to specify how much the curve is allowed to deviate from the original path. 
