...
def tint_flip():
    ''' Switch Tint colors :file: startup/bl_ui/properties_grease_pencil_common.py\:895 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_ui/properties_grease_pencil_common.py$895> _
...
def trace_image(target: 'bpy.types.Object' = None,
                thickness: int = 10,
                resolution: int = 5,
                scale: float = 1.0,
                sample: float = 0.0,
    ...
    :type sample: float
    :param threshold: Color Threshold, Determine what is considered white and what black
    :type threshold: float
...
def vertex_color_brightness_contrast(mode: typing.Union[str, int] = 'STROKE',
...
def vertex_color_hsv(mode: typing.Union[str, int] = 'STROKE',
                     h: float = 0.5,
                     s: float = 1.0,
                     v: float = 1.0):
...
def vertex_color_invert(mode: typing.Union[str, int] = 'STROKE'):
    ''' Invert RGB values
...
def vertex_color_levels(mode: typing.Union[str, int] = 'STROKE',
                        offset: float = 0.0,
                        gain: float = 1.0):
...
def vertex_color_set(mode: typing.Union[str, int] = 'STROKE',
                     factor: float = 1.0):
