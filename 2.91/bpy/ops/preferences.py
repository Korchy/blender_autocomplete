...
def keyconfig_test():
    ''' Test key-config for conflicts :file: startup/bl_operators/userpref.py\:194 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$194> _
