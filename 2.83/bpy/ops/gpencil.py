...
def select_material(deselect: bool = False):
...
def tint_flip():
    ''' Switch Tint colors :file: startup/bl_ui/properties_grease_pencil_common.py\:896 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_ui/properties_grease_pencil_common.py$896> _
