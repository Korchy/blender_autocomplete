...
def fbx(filepath: str = "",
        ...
        object_types: typing.Set[typing.Union[int, str]] = {
    ...
    :type object_types: typing.Set[typing.Union[int, str]]
    ...
    :param use_subsurf: Export Subdivision Surface, Export the last Catmull-Rom subidivion modifier as FBX subdivision (Does not apply the modifier even if ‘Apply Modifiers’ is enabled) 
...
def gltf(export_format: typing.Union[int, str] = 'GLB',
         ...
         export_image_format: typing.Union[int, str] = 'NAME',
    ...
    :param ui_tab: ui_tab, Export setting categoriesGENERAL General, General settings.MESHES Meshes, Mesh settings.OBJECTS Objects, Object settings.ANIMATION Animation, Animation settings. 
    ...
    :param export_image_format: Images, Output format for images. PNG is lossless and generally preferred, but JPEG might be preferable for web applications due to the smaller file sizeNAME Automatic, Determine the image format from the blender image name.JPEG JPEG Format (.jpg), Encode and save textures as .jpg files. Be aware of a possible loss in quality.PNG PNG Format (.png), Encode and save textures as .png files. 
    ...
    :param export_nla_strips: NLA Strips, Export NLA Strip animations 
