...
def mesh_filter(
        type: typing.Union[int, str] = 'INFLATE',
        strength: float = 1.0,
        deform_axis: typing.Set[typing.Union[int, str]] = {'X', 'Y', 'Z'}):
    '''Applies a filter to modify the current mesh 

    :param type: Filter type, Operation that is going to be applied to the meshSMOOTH Smooth, Smooth mesh.SCALE Scale, Scale mesh.INFLATE Inflate, Inflate mesh.SPHERE Sphere, Morph into sphere.RANDOM Random, Randomize vertex positions. 
    ...
    :type deform_axis: typing.Set[typing.Union[int, str]]
    '''
