...
def edit_mesh_extrude_individual_move(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Extrude each individual face separately along local normals :File: `startup/bl_operators/view3d.py\:21 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L21>`__
...
def edit_mesh_extrude_manifold_normal(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Extrude manifold region along normals :File: `startup/bl_operators/view3d.py\:154 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L154>`__
...
def edit_mesh_extrude_move_normal(
        ...
        *,
        dissolve_and_intersect: typing.Optional[typing.Union[bool, typing.
                                                             Any]] = False):
    ''' Extrude region together along the average normal :File: `startup/bl_operators/view3d.py\:120 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L120>`__
...
def edit_mesh_extrude_move_shrink_fatten(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Extrude region together along local normals :File: `startup/bl_operators/view3d.py\:137 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L137>`__
...
def transform_gizmo_set(
    ...
    ''' Set the current transform gizmo :File: `startup/bl_operators/view3d.py\:196 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L196>`__
