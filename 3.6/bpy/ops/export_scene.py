...
def obj(override_context: typing.Optional[
        ...
        *,
        ...
        axis_forward: typing.Optional[typing.Any] = '-Z',
        axis_up: typing.Optional[typing.Any] = 'Y'):
    ''' Save a Wavefront OBJ File :File: `addons/io_scene_obj/__init__.py\:337 <https://projects.blender.org/blender/blender-addons/addons/io_scene_obj/__init__.py#L337>`__
