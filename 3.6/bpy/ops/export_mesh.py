...
def ply(override_context: typing.Optional[
    ...
    ''' Export as a Stanford PLY with normals, vertex colors and texture coordinates :File: `addons/io_mesh_ply/__init__.py\:132 <https://projects.blender.org/blender/blender-addons/addons/io_mesh_ply/__init__.py#L132>`__
