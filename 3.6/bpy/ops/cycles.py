...
def denoise_animation(
    ...
    ''' Denoise rendered animation sequence using current scene and view layer settings. Requires denoising data passes and output to OpenEXR multilayer files :File: `addons/cycles/operators.py\:52 <https://projects.blender.org/blender/blender-addons/addons/cycles/operators.py#L52>`__
...
def merge_images(
        ...
        *,
        ...
        output_filepath: typing.Union[str, typing.Any] = ""):
    ''' Combine OpenEXR multi-layer images rendered with different sample ranges into one image with reduced noise :File: `addons/cycles/operators.py\:140 <https://projects.blender.org/blender/blender-addons/addons/cycles/operators.py#L140>`__
...
def use_shading_nodes(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Enable nodes on a material, world or light :File: `addons/cycles/operators.py\:22 <https://projects.blender.org/blender/blender-addons/addons/cycles/operators.py#L22>`__
