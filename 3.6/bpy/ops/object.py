...
def geometry_nodes_move_to_nodes(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Move inputs and outputs from in the modifier to a new node group :File: `startup/bl_operators/geometry_nodes.py\:118 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L118>`__
...
def quick_liquid(
    ...
    ''' Make selected objects liquid :File: `startup/bl_operators/object_quick_effects.py\:539 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object_quick_effects.py#L539>`__
...
def quick_smoke(
        ...
        *,
        ...
        show_flows: typing.Optional[typing.Union[bool, typing.Any]] = False):
    ''' Use selected objects as smoke emitters :File: `startup/bl_operators/object_quick_effects.py\:434 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object_quick_effects.py#L434>`__
