...
def obj(override_context: typing.Optional[
        ...
        *,
        ...
        axis_forward: typing.Optional[typing.Any] = '-Z',
        axis_up: typing.Optional[typing.Any] = 'Y'):
    ''' Load a Wavefront OBJ File :File: `addons/io_scene_obj/__init__.py\:104 <https://projects.blender.org/blender/blender-addons/addons/io_scene_obj/__init__.py#L104>`__
