...
def ply(override_context: typing.Optional[
    ...
    ''' Load a PLY geometry file :File: `addons/io_mesh_ply/__init__.py\:65 <https://projects.blender.org/blender/blender-addons/addons/io_mesh_ply/__init__.py#L65>`__
