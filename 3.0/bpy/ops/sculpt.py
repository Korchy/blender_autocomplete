...
def expand(target: typing.Union[int, str] = 'MASK',
           falloff_type: typing.Union[int, str] = 'GEODESIC',
           invert: bool = False,
    ...
    :type falloff_type: typing.Union[int, str]
...
def mask_init(mode: typing.Union[int, str] = 'RANDOM_PER_VERTEX'):
