...
def add_collection(name: str = "Collection", session_uuid: int = 0):
...
def add_mask(name: str = "Mask", session_uuid: int = 0):
...
def add_object(name: str = "Object", session_uuid: int = 0):
...
def add_texture(name: str = "Texture", session_uuid: int = 0):
...
def collapse_hide_unused_toggle():
    ''' Toggle collapsed nodes and hide unused sockets :file: startup/bl_operators/node.py\:271 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/node.py$271> _
...
def copy_geometry_node_group_assign():
    ''' Copy the active geometry node group and assign it to the active modifier :file: startup/bl_operators/geometry_nodes.py\:109 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/geometry_nodes.py$109> _
...
def new_geometry_node_group_assign():
    ''' Create a new geometry node group and assign it to the active modifier :file: startup/bl_operators/geometry_nodes.py\:83 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/geometry_nodes.py$83> _
...
def new_geometry_nodes_modifier():
    ''' Create a new modifier with a new geometry node group :file: startup/bl_operators/geometry_nodes.py\:63 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/geometry_nodes.py$63> _
...
def tree_path_parent():
    ''' Go to parent node tree :file: startup/bl_operators/node.py\:301 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/node.py$301> _
...
def tree_socket_change_type(in_out: typing.Union[int, str] = 'IN',
                            socket_type: typing.Union[int, str] = 'DEFAULT'):
    ''' Change the type of a socket of the current node tree

    :param in_out: Socket Type
    :type in_out: typing.Union[int, str]
    :param socket_type: Socket Type
    :type socket_type: typing.Union[int, str]
    '''
