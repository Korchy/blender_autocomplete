...
def knife_tool(use_occlude_geometry: bool = True,
               ...
               xray: bool = True,
               visible_measurements: typing.Union[int, str] = 'NONE',
               angle_snapping: typing.Union[int, str] = 'NONE',
    ...
    :type visible_measurements: typing.Union[int, str]
    ...
    :type angle_snapping: typing.Union[int, str]
