...
def addon_refresh():
    ''' Scan add-on directories for new modules :file: startup/bl_operators/userpref.py\:583 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$583> _
...
def copy_prev():
    ''' Copy settings from previous version :file: startup/bl_operators/userpref.py\:154 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$154> _
...
def keyconfig_remove():
    ''' Remove key config :file: startup/bl_operators/userpref.py\:427 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$427> _
...
def keyconfig_test():
    ''' Test key configuration for conflicts :file: startup/bl_operators/userpref.py\:176 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$176> _
...
def keyitem_add():
    ''' Add key map item :file: startup/bl_operators/userpref.py\:375 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$375> _
...
def studiolight_show():
    ''' Show light preferences :file: startup/bl_operators/userpref.py\:1145 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$1145> _
