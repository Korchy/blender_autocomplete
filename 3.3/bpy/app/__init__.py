...
ffmpeg = None
''' Constant value bpy.app.ffmpeg(supported=True, avcodec_version=(59, 18, 100), avcodec_version_string='59, 18, 100', avdevice_version=(59, 4, 100), avdevice_version_string='59, 4, 100', avformat_version=(59, 16, 100), avformat_version_string='59, 16, 100', avutil_version=(57, 17, 100), avutil_version_string='57, 17, 100', swscale_version=(6, 4, 100), swscale_version_string=' 6, 4, 100')
'''

ocio = None
''' Constant value bpy.app.ocio(supported=True, version=(2, 1, 1), version_string=' 2, 1, 1')
'''

oiio = None
''' Constant value bpy.app.oiio(supported=True, version=(2, 3, 13), version_string=' 2, 3, 13')
'''
...
openvdb = None
''' Constant value bpy.app.openvdb(supported=True, version=(9, 0, 0), version_string=' 9, 0, 0')
'''
...
usd = None
''' Constant value bpy.app.usd(supported=True, version=(0, 22, 3), version_string=' 0, 22, 3')
'''
