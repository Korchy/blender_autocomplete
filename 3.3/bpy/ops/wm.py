...
def alembic_export(override_context: typing.
                   ...
                   *,
                   ...
                   init_scene_frame_range: bool = True):
...
def alembic_import(override_context: typing.
                   Union[typing.Dict, 'bpy.types.Context'] = None,
                   execution_context: typing.Union[str, int] = None,
                   undo: bool = None,
                   *,
...
def batch_rename(
        ...
        *,
        ...
        actions: bpy.types.
        bpy_prop_collection['bl_operators.wm.BatchRenameAction'] = None):
...
def blend_strings_utf8_validate(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: bool = None):
    ''' Check and fix all strings in current .blend file to be valid UTF-8 Unicode (needed for some old, 2.4x area files) :file: startup/bl_operators/file.py\:287 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/file.py$287> _
...
def keyconfig_preset_add(override_context: typing.
                         Union[typing.Dict, 'bpy.types.Context'] = None,
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None,
                         *,
...
def obj_export(override_context: typing.
               Union[typing.Dict, 'bpy.types.Context'] = None,
               execution_context: typing.Union[str, int] = None,
               undo: bool = None,
               *,
...
def operator_cheat_sheet(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None):
    ''' List all the operators in a text-block, useful for scripting :file: startup/bl_operators/wm.py\:2059 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2059> _
...
def properties_edit(
    ...
    :type default_float: typing.Union[typing.List[float], typing.Tuple[float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float], 'mathutils.Vector']
    :param min_float: Min
...
def radial_control(override_context: typing.
                   Union[typing.Dict, 'bpy.types.Context'] = None,
                   execution_context: typing.Union[str, int] = None,
                   undo: bool = None,
                   *,
...
def read_factory_settings(override_context: typing.
                          Union[typing.Dict, 'bpy.types.Context'] = None,
                          execution_context: typing.Union[str, int] = None,
                          undo: bool = None,
                          *,
...
def recover_auto_save(override_context: typing.
                      Union[typing.Dict, 'bpy.types.Context'] = None,
                      execution_context: typing.Union[str, int] = None,
                      undo: bool = None,
                      *,
...
def redraw_timer(override_context: typing.
                 ...
                 undo: bool = None,
                 *,
                 type: typing.Union[str, int] = 'DRAW',
                 iterations: int = 10,
...
def set_stereo_3d(override_context: typing.
                  Union[typing.Dict, 'bpy.types.Context'] = None,
                  execution_context: typing.Union[str, int] = None,
                  undo: bool = None,
                  *,
                  display_mode: typing.Union[int, str] = 'ANAGLYPH',
...
def toolbar(override_context: typing.Union[typing.
            ...
            execution_context: typing.Union[str, int] = None,
            undo: bool = None):
    ''' Undocumented, consider contributing <https://developer.blender.org/T51061> __. :file: startup/bl_operators/wm.py\:2245 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2245> _
...
def toolbar_fallback_pie(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: bool = None):
    ''' Undocumented, consider contributing <https://developer.blender.org/T51061> __. :file: startup/bl_operators/wm.py\:2269 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2269> _
...
def toolbar_prompt(override_context: typing.
                   ...
                   execution_context: typing.Union[str, int] = None,
                   undo: bool = None):
    ''' Leader key like functionality for accessing tools :file: startup/bl_operators/wm.py\:2369 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2369> _
...
def usd_import(
        ...
        *,
        ...
        mtl_name_collision_mode: typing.Union[str, int] = 'MAKE_UNIQUE'):
    ...
    :type mtl_name_collision_mode: typing.Union[str, int]
    '''
...
def xr_navigation_fly(
        ...
        undo: bool = None,
        *,
        mode: typing.Union[str, int] = 'VIEWER_FORWARD',
        lock_location_z: bool = False,
        lock_direction: bool = False,
        speed_frame_based: bool = True,
        speed_min: float = 0.018,
        speed_max: float = 0.054,
        speed_interpolation0: typing.
        Union[typing.List[float], typing.
              Tuple[float, float], 'mathutils.Vector'] = (0.0, 0.0),
        speed_interpolation1: typing.
        Union[typing.List[float], typing.
              Tuple[float, float], 'mathutils.Vector'] = (1.0, 1.0)):
    ...
    :type speed_interpolation0: typing.Union[typing.List[float], typing.Tuple[float, float], 'mathutils.Vector']
    :param speed_interpolation1: Speed Interpolation 1, Second cubic spline control point between min/max speeds
    :type speed_interpolation1: typing.Union[typing.List[float], typing.Tuple[float, float], 'mathutils.Vector']
    '''
...
def xr_navigation_teleport(
        ...
        undo: bool = None,
        *,
        teleport_axes: typing.List[bool] = (True, True, True),
        ...
        color: typing.
        Union[typing.List[float], typing.
              Tuple[float, float, float, float], 'mathutils.Vector'] = (0.35,
                                                                        0.35,
                                                                        1.0,
                                                                        1.0)):
