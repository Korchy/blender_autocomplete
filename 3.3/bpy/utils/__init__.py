...
def blend_paths(absolute: bool = False,
                packed: bool = False,
                local: bool = False) -> typing.List[str]:
...
def make_rna_paths(struct_name: str, prop_name: str,
                   enum_name: str) -> typing.Tuple:
...
def modules_from_path(path: str, loaded_modules: typing.Set) -> typing.List:
    ...
    :type loaded_modules: typing.Set
    :rtype: typing.List
...
def preset_paths(subdir: str) -> typing.List:
...
def register_submodule_factory(
        module_name: str, submodule_names: typing.List[str]) -> typing.Tuple:
...
def smpte_from_seconds(time: int, *, fps=None, fps_base=None) -> str:
