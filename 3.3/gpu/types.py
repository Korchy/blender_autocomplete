...
class GPUShader:
    ...
    def uniform_bool(self, name: str, seq: typing.List):
...
class GPUStageInterfaceInfo:
    ''' List of varyings between shader stages. :param name: Name of the interface block. :type value: str
    '''
...
class GPUTexture:
    ...
    def clear(self, format='FLOAT', value: typing.List = (0.0, 0.0, 0.0, 1.0)):
...
class GPUVertBuf:
    ''' Contains a VBO. :param format: Vertex format. :type buf: gpu.types.GPUVertFormat :param len: Amount of vertices that will fit into this buffer. :type type: int
    '''
