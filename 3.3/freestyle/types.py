...
class Curve:
    ...
    def push_vertex_back(self, vertex: 'SVertex'):
    ...
    def push_vertex_front(self, vertex: 'SVertex'):
...
class Material:
    ...
    def __init__(self):
        ...
        :type line: 'mathutils.Vector'
        :param diffuse: The diffuse color.
        :type diffuse: 'mathutils.Vector'
        :param ambient: The ambient color.
        :type ambient: 'mathutils.Vector'
        :param specular: The specular color.
        :type specular: 'mathutils.Vector'
        :param emission: The emissive color.
        :type emission: 'mathutils.Vector'
...
class Operators:
    ...
    def bidirectional_chain(it: 'ChainingIterator',
                            pred: typing.Optional['UnaryPredicate1D']):
        ...
        :type pred: typing.Optional['UnaryPredicate1D']
        '''
        pass
...
class SVertex:
    ...
    def add_normal(self, normal: 'mathutils.Vector'):
...
class StrokeAttribute:
    ...
    def set_attribute_vec2(self, name: str, value: 'mathutils.Vector'):
    ...
    def set_attribute_vec3(self, name: str, value: 'mathutils.Vector'):
