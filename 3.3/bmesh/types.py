...
class BMEdgeSeq:
    ...
    def new(self, verts: 'BMVert',
            example: typing.Optional['BMEdge'] = None) -> 'BMEdge':
        ''' Create a new edge from a given pair of verts.

        :param verts: Vertex pair.
        :type verts: 'BMVert'
        :param example: Existing edge to initialize settings (optional argument).
        :type example: typing.Optional['BMEdge']
        :rtype: 'BMEdge'
...
class BMVertSeq:
    ...
    def new(self,
            co: typing.Optional[typing.Tuple[float]] = (0.0, 0.0, 0.0),
            example: 'BMVert' = None) -> 'BMVert':
        ''' Create a new vertex.

        :param co: The initial location of the vertex (optional argument).
        :type co: typing.Optional[typing.Tuple[float]]
...
class BMesh:
    ...
    edges: typing.Union[typing.List['BMEdg'], 'BMEdgeSeq'] = None
    ''' This meshes edge sequence (read-only).

    :type: typing.Union[typing.List['BMEdg'], 'BMEdgeSeq']
    '''

    faces: typing.Union[typing.List['BMFac'], 'BMFaceSeq'] = None
    ''' This meshes face sequence (read-only).

    :type: typing.Union[typing.List['BMFac'], 'BMFaceSeq']
    '''
    ...
    select_history: typing.Union[typing.
                                 List['BMEditSel'], 'BMEditSelSeq'] = None
    ''' Sequence of selected items (the last is displayed as active).

    :type: typing.Union[typing.List['BMEditSel'], 'BMEditSelSeq']
    '''
