...
def beautify_fill(
        ...
        method: typing.Union[str, int]) -> typing.Dict:
...
def bevel(bm: 'bmesh.types.BMesh',
          geom: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace'],
          offset: float, offset_type: typing.Union[str, int],
          profile_type: typing.Union[str, int], segments: int, profile: float,
          affect: typing.Union[str, int], clamp_overlap: bool, material: int,
          ...
          vmesh_method: typing.Union[str, int]) -> typing.Dict:
    ''' Bevel. Bevels edges and vertices

    :param bm: The bmesh to operate on.
    :type bm: 'bmesh.types.BMesh'
    :param geom: input edges and vertices
    :type geom: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace']
...
def bisect_plane(
        ...
        geom: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace'],
        dist: float, plane_co: 'mathutils.Vector',
        plane_no: 'mathutils.Vector', use_snap_center: bool, clear_outer: bool,
        clear_inner: bool) -> typing.Dict:
...
def connect_verts(bm: 'bmesh.types.BMesh',
                  ...
                  check_degenerate: bool) -> typing.Dict:
    ''' Connect Verts. Split faces by adding edges that connect **verts**.
...
def connect_verts_nonplanar(
        bm: 'bmesh.types.BMesh', angle_limit: float,
        faces: typing.List['bmesh.types.BMFace']) -> typing.Dict:
...
def contextual_create(
        bm: 'bmesh.types.BMesh',
        geom: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace'],
        mat_nr: int, use_smooth: bool) -> typing.Dict:
...
def convex_hull(
        bm: 'bmesh.types.BMesh',
        input: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace'],
        use_existing_faces: bool) -> typing.Dict:
    ...
    :type input: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace']
...
def create_cone(bm: 'bmesh.types.BMesh', cap_ends: bool, cap_tris: bool,
                segments: int, radius1: float, radius2: float, depth: float,
                matrix: 'mathutils.Matrix', calc_uvs: bool) -> typing.Dict:
...
def create_icosphere(bm: 'bmesh.types.BMesh', subdivisions: int, radius: float,
...
def create_uvsphere(bm: 'bmesh.types.BMesh', u_segments: int, v_segments: int,
                    radius: float, matrix: 'mathutils.Matrix',
                    calc_uvs: bool) -> typing.Dict:
...
def create_vert(bm: 'bmesh.types.BMesh',
                co: 'mathutils.Vector') -> typing.Dict:
...
def dissolve_edges(bm: 'bmesh.types.BMesh',
                   ...
                   use_face_split: bool) -> typing.Dict:
    ''' Dissolve Edges.
...
def dissolve_limit(bm: 'bmesh.types.BMesh', angle_limit: float,
                   ...
                   verts: typing.List['bmesh.types.BMVert'],
                   edges: typing.List['bmesh.types.BMEdge'],
                   delimit: typing.Set) -> typing.Dict:
...
def duplicate(bm: 'bmesh.types.BMesh',
              ...
              use_edge_flip_from_face: bool) -> typing.Dict:
...
def edgenet_fill(bm: 'bmesh.types.BMesh',
                 edges: typing.List['bmesh.types.BMEdge'], mat_nr: int,
                 use_smooth: bool, sides: int) -> typing.Dict:
...
def edgenet_prepare(bm: 'bmesh.types.BMesh',
                    edges: typing.List['bmesh.types.BMEdge']) -> typing.Dict:
...
def extrude_discrete_faces(
        bm: 'bmesh.types.BMesh', faces: typing.List['bmesh.types.BMFace'],
        use_normal_flip: bool, use_select_history: bool) -> typing.Dict:
...
def extrude_face_region(
        bm: 'bmesh.types.BMesh',
        geom: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace'],
        edges_exclude: typing.Set, use_keep_orig: bool, use_normal_flip: bool,
        use_normal_from_adjacent: bool, use_dissolve_ortho_edges: bool,
        use_select_history: bool) -> typing.Dict:
...
def face_attribute_fill(bm: 'bmesh.types.BMesh',
                        faces: typing.List['bmesh.types.BMFace'],
                        use_normals: bool, use_data: bool) -> typing.Dict:
...
def grid_fill(bm: 'bmesh.types.BMesh',
              edges: typing.List['bmesh.types.BMEdge'], mat_nr: int,
              use_smooth: bool, use_interp_simple: bool) -> typing.Dict:
...
def inset_individual(
        ...
        use_interpolate: bool, use_relative_offset: bool) -> typing.Dict:
...
def inset_region(
        ...
        depth: float, use_outset: bool) -> typing.Dict:
...
def join_triangles(bm: 'bmesh.types.BMesh',
                   ...
                   angle_shape_threshold: float) -> typing.Dict:
...
def mirror(bm: 'bmesh.types.BMesh',
           ...
           mirror_udim: bool, use_shapekey: bool) -> typing.Dict:
...
def offset_edgeloops(bm: 'bmesh.types.BMesh',
                     edges: typing.List['bmesh.types.BMEdge'],
                     use_cap_endpoint: bool) -> typing.Dict:
...
def poke(bm: 'bmesh.types.BMesh', faces: typing.List['bmesh.types.BMFace'],
         ...
         use_relative_offset: bool) -> typing.Dict:
...
def region_extend(
        bm: 'bmesh.types.BMesh',
        geom: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace'],
        use_contract: bool, use_faces: bool,
        use_face_step: bool) -> typing.Dict:
...
def reverse_colors(bm: 'bmesh.types.BMesh',
                   faces: typing.List['bmesh.types.BMFace'], color_index: int):
...
def spin(bm: 'bmesh.types.BMesh',
         ...
         steps: int, use_merge: bool, use_normal_flip: bool,
         use_duplicate: bool) -> typing.Dict:
...
def split(bm: 'bmesh.types.BMesh',
          geom: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace'],
          dest: 'bmesh.types.BMesh', use_only_faces: bool) -> typing.Dict:
...
def split_edges(bm: 'bmesh.types.BMesh',
                edges: typing.List['bmesh.types.BMEdge'],
                verts: typing.Optional[typing.List['bmesh.types.BMVert']],
                use_verts: bool) -> typing.Dict:
    ...
    :type verts: typing.Optional[typing.List['bmesh.types.BMVert']]
...
def subdivide_edgering(bm: 'bmesh.types.BMesh',
                       ...
                       profile_shape_factor: float) -> typing.Dict:
...
def subdivide_edges(
        ...
        along_normal: float, cuts: int, seed: int,
        custom_patterns: typing.Dict, edge_percents: typing.Dict,
        quad_corner_type: typing.Union[str, int], use_grid_fill: bool,
        use_single_edge: bool, use_only_quads: bool, use_sphere: bool,
        use_smooth_even: bool) -> typing.Dict:
...
def symmetrize(bm: 'bmesh.types.BMesh',
               input: typing.Union['bmesh.types.BMEdge', 'bmesh.types.BMFace'],
               direction: typing.Union[str, int], dist: float,
               use_shapekey: bool) -> typing.Dict:
...
def translate(bm: 'bmesh.types.BMesh', vec: 'mathutils.Vector',
              space: 'mathutils.Matrix',
              verts: typing.List['bmesh.types.BMVert'], use_shapekey: bool):
...
def triangle_fill(bm: 'bmesh.types.BMesh', use_beauty: bool,
                  ...
                  normal: typing.Optional['mathutils.Vector']) -> typing.Dict:
    ...
    :type normal: typing.Optional['mathutils.Vector']
    :rtype: typing.Dict
...
def triangulate(bm: 'bmesh.types.BMesh',
                ...
                ngon_method: typing.Union[str, int]) -> typing.Dict:
    ''' Triangulate.
...
def weld_verts(bm: 'bmesh.types.BMesh',
               targetmap: typing.Union[typing.Dict, typing.Dict, typing.Dict]):
    ...
    :type targetmap: typing.Union[typing.Dict, typing.Dict, typing.Dict]
    '''
...
def wireframe(bm: 'bmesh.types.BMesh',
              ...
              use_relative_offset: bool, material_offset: int) -> typing.Dict:
