...
def use_shading_nodes(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Enable nodes on a material, world or light :file:`addons/cycles/operators.py\:22 <https://projects.blender.org/blender/blender-addons/addons/cycles/operators.py#L22>`_
