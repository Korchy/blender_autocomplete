...
def anim_transforms_to_deltas(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Convert object animation for normal transforms to delta transforms :file:`startup/bl_operators/object.py\:772 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py#L772>`_
...
def geometry_nodes_move_to_nodes(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Move inputs and outputs from in the modifier to a new node group :file:`startup/bl_operators/geometry_nodes.py\:110 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L110>`_
...
def hide_render_clear_all(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Reveal all render objects by setting the hide render flag :file:`startup/bl_operators/object.py\:679 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py#L679>`_
...
def instance_offset_from_cursor(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Set offset used for collection instances based on cursor position :file:`startup/bl_operators/object.py\:857 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py#L857>`_
...
def instance_offset_from_object(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Set offset used for collection instances based on the active object position :file:`startup/bl_operators/object.py\:889 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py#L889>`_
...
def instance_offset_to_cursor(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Set cursor position to the offset used for collection instances :file:`startup/bl_operators/object.py\:872 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py#L872>`_
...
def isolate_type_render(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Hide unselected render objects of same type as active by setting the hide render flag :file:`startup/bl_operators/object.py\:659 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py#L659>`_
...
def join_uvs(override_context: typing.Optional[
        typing.Union[typing.Dict, 'bpy.types.Context']] = None,
             execution_context: typing.Optional[typing.Union[str, int]] = None,
             undo: typing.Optional[bool] = None):
    ''' Transfer UV Maps from active to selected objects (needs matching geometry) :file:`startup/bl_operators/object.py\:566 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py#L566>`_
...
def make_dupli_face(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Convert objects into instanced faces :file:`startup/bl_operators/object.py\:647 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py#L647>`_
