...
def select_next_item(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Select the next element (using selection order) :file:`startup/bl_operators/mesh.py\:195 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/mesh.py#L195>`_
...
def select_prev_item(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Select the previous element (using selection order) :file:`startup/bl_operators/mesh.py\:220 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/mesh.py#L220>`_
