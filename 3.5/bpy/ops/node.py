...
def collapse_hide_unused_toggle(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Toggle collapsed nodes and hide unused sockets :file:`startup/bl_operators/node.py\:165 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L165>`_
...
def gltf_settings_node_operator(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Add a node to the active tree for glTF export :file:`addons/io_scene_gltf2/blender/com/gltf2_blender_ui.py\:29 <https://projects.blender.org/blender/blender-addons/addons/io_scene_gltf2/blender/com/gltf2_blender_ui.py#L29>`_
...
def new_geometry_node_group_assign(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Create a new geometry node group and assign it to the active modifier :file:`startup/bl_operators/geometry_nodes.py\:229 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L229>`_
...
def new_geometry_nodes_modifier(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Create a new modifier with a new geometry node group :file:`startup/bl_operators/geometry_nodes.py\:207 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L207>`_
...
def tree_path_parent(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Go to parent node tree :file:`startup/bl_operators/node.py\:195 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L195>`_
