...
def bundles_to_mesh(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Create vertex cloud using coordinates of reconstructed tracks :file:`startup/bl_operators/clip.py\:281 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L281>`_
...
def constraint_to_fcurve(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Create F-Curves for object which will copy object's movement caused by this constraint :file:`startup/bl_operators/clip.py\:519 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L519>`_
...
def delete_proxy(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Delete movie clip proxy files from the hard drive :file:`startup/bl_operators/clip.py\:348 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L348>`_
...
def set_active_clip(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Undocumented, consider `contributing <https://developer.blender.org/>`__. :file:`startup/bl_operators/clip.py\:210 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L210>`_
...
def set_viewport_background(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Set current movie clip as a camera background in 3D Viewport (works only when a 3D Viewport is visible) :file:`startup/bl_operators/clip.py\:409 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L409>`_
...
def setup_tracking_scene(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Prepare scene for compositing 3D objects into this footage :file:`startup/bl_operators/clip.py\:971 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L971>`_
...
def track_settings_as_default(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Copy tracking settings from active track to default settings :file:`startup/bl_operators/clip.py\:1000 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L1000>`_
...
def track_settings_to_track(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Copy tracking settings from active track to selected tracks :file:`startup/bl_operators/clip.py\:1049 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L1049>`_
...
def track_to_empty(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Create an Empty object which will be copying movement of active track :file:`startup/bl_operators/clip.py\:257 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L257>`_
