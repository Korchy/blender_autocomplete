...
def project_apply(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Project edited image back onto the object :file:`startup/bl_operators/image.py\:179 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/image.py#L179>`_
...
def project_edit(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Edit a snapshot of the 3D Viewport in an external image editor :file:`startup/bl_operators/image.py\:109 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/image.py#L109>`_
