...
def edit_mesh_extrude_individual_move(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Extrude each individual face separately along local normals :file:`startup/bl_operators/view3d.py\:21 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L21>`_
...
def edit_mesh_extrude_manifold_normal(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Extrude manifold region along normals :file:`startup/bl_operators/view3d.py\:154 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L154>`_
...
def edit_mesh_extrude_move_shrink_fatten(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Extrude region together along local normals :file:`startup/bl_operators/view3d.py\:137 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L137>`_
...
def interactive_add(
        ...
        *,
        ...
        plane_axis: typing.Optional[typing.Union[str, int]] = 'Z',
        plane_axis_auto: typing.Optional[typing.Union[bool, typing.
                                                      Any]] = False,
    ...
    :type plane_axis: typing.Optional[typing.Union[str, int]]
    :param plane_axis_auto: Auto Axis, Select the closest axis when placing objects (surface overrides)
    :type plane_axis_auto: typing.Optional[typing.Union[bool, typing.Any]]
