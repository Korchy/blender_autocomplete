...
def object_settings_copy(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Copy Rigid Body settings from active object to selected :file:`startup/bl_operators/rigidbody.py\:43 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/rigidbody.py#L43>`_
