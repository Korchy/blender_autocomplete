...
class HAIR_MT_add_attribute(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
    ...
    def add_standard_attribute(self, layout, hair, name, data_type, domain):
        ''' 
...
class HAIR_UL_attributes(bpy_types.UIList, bpy_types._GenericUI):
    bl_rna = None
    ''' '''
...
class DATA_PT_hair_attributes(DataButtonsPanel, bpy_types.Panel,
                              bpy_types._GenericUI):
    COMPAT_ENGINES = None
    ''' '''
