...
def cycles_viewport_sampling_preset_add(name: str = "",
                                        remove_name: bool = False,
                                        remove_active: bool = False):
...
def play_rendered_anim():
    ''' Play back rendered frames/movies using an external player :file: startup/bl_operators/screen_play_rendered_anim.py\:63 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/screen_play_rendered_anim.py$63> _
