...
def addon_refresh():
    ''' Scan add-on directories for new modules :file: startup/bl_operators/userpref.py\:575 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$575> _
...
def copy_prev():
    ''' Copy settings from previous version :file: startup/bl_operators/userpref.py\:146 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$146> _
...
def keyconfig_remove():
    ''' Remove key config :file: startup/bl_operators/userpref.py\:419 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$419> _
...
def keyconfig_test():
    ''' Test key configuration for conflicts :file: startup/bl_operators/userpref.py\:168 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$168> _
...
def keyitem_add():
    ''' Add key map item :file: startup/bl_operators/userpref.py\:367 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$367> _
...
def studiolight_show():
    ''' Show light preferences :file: startup/bl_operators/userpref.py\:1137 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/userpref.py$1137> _
