...
def gltf(filepath: str = "",
         ...
         optimize_animation_size: bool = True,
    ...
    :param optimize_animation_size: Optimize Animation Size, Reduces exported filesize by removing duplicate keyframesCan cause problems with stepped animation
    :type optimize_animation_size: bool
