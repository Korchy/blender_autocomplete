...
def change_spreadsheet_data_source(component_type: int = 0,
...
def remove_row_filter_rule(index: int = 0):
...
def toggle_pin():
    ''' Turn on or off pinning :file: startup/bl_operators/spreadsheet.py\:35 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/spreadsheet.py$35> _
