...
class USERPREF_PT_text_editor_presets(bl_ui.utils.PresetPanel, bpy_types.Panel,
                                      bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class USERPREF_PT_edit_node_editor(EditingPanel, CenterAlignMixIn,
                                   bpy_types.Panel, bpy_types._GenericUI):
    bl_context = None
    ''' '''
...
class USERPREF_PT_extensions(ExtensionsPanel, bpy_types.Panel,
                             bpy_types._GenericUI):
    bl_context = None
    ''' '''
...
class USERPREF_PT_file_paths_extension_repos(FilePathsPanel, bpy_types.Panel,
                                             bpy_types._GenericUI):
    bl_context = None
    ''' '''
...
class USERPREF_PT_text_editor(FilePathsPanel, bpy_types.Panel,
                              bpy_types._GenericUI):
    bl_context = None
    ''' '''
