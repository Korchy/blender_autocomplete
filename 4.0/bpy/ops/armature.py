...
def assign_to_collection(
    ...
    :type execution_context: typing.Optional[typing.Union[str, int]]
    :type undo: typing.Optional[bool]
    :param collection: Collection, The bone collection to move the selected bones to
    :type collection: typing.Optional[typing.Union[str, int, typing.Any]]
    :param new_collection_name: Name, Name of the newly added bone collection
...
def collection_show_all(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Show all bone collections :File: `startup/bl_operators/anim.py\:538 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L538>`__
...
def collection_solo_visibility(
        ...
        *,
        name: typing.Union[str, typing.Any] = ""):
    ''' Hide all other bone collections and show the active one :File: `startup/bl_operators/anim.py\:521 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L521>`__
...
def copy_bone_color_to_selected(
    ...
    ''' Copy the bone color of the active bone to all selected bones :File: `startup/bl_operators/anim.py\:451 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L451>`__
