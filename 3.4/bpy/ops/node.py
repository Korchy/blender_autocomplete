...
def add_group_asset(override_context: typing.
                    Union[typing.Dict, 'bpy.types.Context'] = None,
                    execution_context: typing.Union[str, int] = None,
                    undo: typing.Optional[bool] = None):
...
def add_search(override_context: typing.
               ...
               undo: typing.Optional[bool] = None,
               *,
               use_transform: typing.Union[bool, typing.Any] = True):
...
def collapse_hide_unused_toggle(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: typing.Optional[bool] = None):
    ''' Toggle collapsed nodes and hide unused sockets :file: `startup/bl_operators/node.py\:165 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/node.py$165>`_
...
def deactivate_viewer(override_context: typing.
                      Union[typing.Dict, 'bpy.types.Context'] = None,
                      execution_context: typing.Union[str, int] = None,
                      undo: typing.Optional[bool] = None):
...
def tree_path_parent(override_context: typing.
                     ...
                     execution_context: typing.Union[str, int] = None,
                     undo: typing.Optional[bool] = None):
    ''' Go to parent node tree :file: `startup/bl_operators/node.py\:195 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/node.py$195>`_
