...
def dyntopo_detail_size_edit(override_context: typing.
                             Union[typing.Dict, 'bpy.types.Context'] = None,
                             execution_context: typing.Union[str, int] = None,
                             undo: typing.Optional[bool] = None):
...
def expand(override_context: typing.Union[typing.
                                          Dict, 'bpy.types.Context'] = None,
           execution_context: typing.Union[str, int] = None,
           undo: typing.Optional[bool] = None,
           *,
...
def face_set_change_visibility(
    ...
    :type execution_context: typing.Union[str, int]
    :type undo: typing.Optional[bool]
    :param mode: Mode * ``TOGGLE`` Toggle Visibility -- Hide all Face Sets except for the active one. * ``SHOW_ACTIVE`` Show Active Face Set -- Show Active Face Set. * ``HIDE_ACTIVE`` Hide Active Face Sets -- Hide Active Face Sets. * ``INVERT`` Invert Face Set Visibility -- Invert Face Set Visibility.
    :type mode: typing.Optional[typing.Any]
    '''
...
def mask_from_cavity(override_context: typing.
                     Union[typing.Dict, 'bpy.types.Context'] = None,
                     execution_context: typing.Union[str, int] = None,
                     undo: typing.Optional[bool] = None,
                     *,
...
def mask_init(override_context: typing.Union[typing.
                                             Dict, 'bpy.types.Context'] = None,
              execution_context: typing.Union[str, int] = None,
              undo: typing.Optional[bool] = None,
              *,
...
def reveal_all(override_context: typing.
               Union[typing.Dict, 'bpy.types.Context'] = None,
               execution_context: typing.Union[str, int] = None,
               undo: typing.Optional[bool] = None):
    ''' Unhide all geometry
