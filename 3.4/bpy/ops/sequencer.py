...
def change_path(override_context: typing.
                Union[typing.Dict, 'bpy.types.Context'] = None,
                execution_context: typing.Union[str, int] = None,
                undo: typing.Optional[bool] = None,
                *,
...
def crossfade_sounds(override_context: typing.
                     ...
                     execution_context: typing.Union[str, int] = None,
                     undo: typing.Optional[bool] = None):
    ''' Do cross-fading volume animation of two selected sound strips :file: `startup/bl_operators/sequencer.py\:26 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/sequencer.py$26>`_
...
def deinterlace_selected_movies(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: typing.Optional[bool] = None):
    ''' Deinterlace all selected movie sources :file: `startup/bl_operators/sequencer.py\:114 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/sequencer.py$114>`_
...
def fades_clear(override_context: typing.
                ...
                execution_context: typing.Union[str, int] = None,
                undo: typing.Optional[bool] = None):
    ''' Removes fade animation from selected sequences :file: `startup/bl_operators/sequencer.py\:133 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/sequencer.py$133>`_
