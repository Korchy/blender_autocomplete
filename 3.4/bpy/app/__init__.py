...
oiio = None
''' Constant value bpy.app.oiio(supported=True, version=(2, 3, 20), version_string=' 2, 3, 20')
'''

opensubdiv = None
''' Constant value bpy.app.opensubdiv(supported=True, version=(3, 4, 4), version_string=' 3, 4, 4')
'''
