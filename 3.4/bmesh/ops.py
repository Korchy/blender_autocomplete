...
def bevel(bm: 'bmesh.types.BMesh', geom: typing.
          Union[typing.List['bmesh.types.BMVert'], typing.
                List['bmesh.types.BMEdge'], typing.List['bmesh.types.BMFace']],
...
def bisect_plane(
        ...
        geom: typing.Union[typing.List['bmesh.types.BMVert'], typing.
                           ...
                           List['bmesh.types.BMFace']], dist: float,
...
def create_circle(
        bm: 'bmesh.types.BMesh', cap_ends: bool, cap_tris: bool, segments: int,
        radius: float,
...
def create_cone(
        bm: 'bmesh.types.BMesh', cap_ends: bool, cap_tris: bool, segments: int,
        radius1: float, radius2: float, depth: float,
        matrix: typing.Union[typing.Sequence[float], 'mathutils.Matrix'],
        calc_uvs: bool) -> typing.Dict:
...
def create_cube(
        bm: 'bmesh.types.BMesh', size: float,
        matrix: typing.Union[typing.Sequence[float], 'mathutils.Matrix'],
        calc_uvs: bool) -> typing.Dict:
...
def create_grid(
        bm: 'bmesh.types.BMesh', x_segments: int, y_segments: int, size: float,
        matrix: typing.Union[typing.Sequence[float], 'mathutils.Matrix'],
        calc_uvs: bool) -> typing.Dict:
...
def create_icosphere(
        bm: 'bmesh.types.BMesh', subdivisions: int, radius: float,
        matrix: typing.Union[typing.Sequence[float], 'mathutils.Matrix'],
        calc_uvs: bool) -> typing.Dict:
...
def create_uvsphere(
        bm: 'bmesh.types.BMesh', u_segments: int, v_segments: int,
        radius: float,
        matrix: typing.Union[typing.Sequence[float], 'mathutils.Matrix'],
        calc_uvs: bool) -> typing.Dict:
...
def mirror(
        ...
        Union[typing.List['bmesh.types.BMVert'], typing.
              List['bmesh.types.BMEdge'], typing.List['bmesh.types.BMFace']],
        matrix: typing.Union[typing.Sequence[float], 'mathutils.Matrix'],
        merge_dist: float, axis: typing.Union[str, int], mirror_u: bool,
        mirror_v: bool, mirror_udim: bool, use_shapekey: bool) -> typing.Dict:
...
def pointmerge(
        bm: 'bmesh.types.BMesh', verts: typing.List['bmesh.types.BMVert'],
        merge_co: typing.Union[typing.Sequence[float], 'mathutils.Vector']):
...
def rotate(bm: 'bmesh.types.BMesh',
           cent: typing.Union[typing.Sequence[float], 'mathutils.Vector'],
           matrix: typing.Union[typing.Sequence[float], 'mathutils.Matrix'],
           verts: typing.List['bmesh.types.BMVert'],
           space: typing.Union[typing.Sequence[float], 'mathutils.Matrix'],
           use_shapekey: bool):
...
def scale(bm: 'bmesh.types.BMesh',
          vec: typing.Union[typing.Sequence[float], 'mathutils.Vector'],
          space: typing.Union[typing.Sequence[float], 'mathutils.Matrix'],
...
def spin(bm: 'bmesh.types.BMesh', geom: typing.
         Union[typing.List['bmesh.types.BMVert'], typing.
               List['bmesh.types.BMEdge'], typing.List['bmesh.types.BMFace']],
         cent: typing.Union[typing.Sequence[float], 'mathutils.Vector'],
         axis: typing.Union[typing.Sequence[float], 'mathutils.Vector'],
         dvec: typing.Union[typing.Sequence[float], 'mathutils.Vector'],
         angle: float,
         space: typing.Union[typing.Sequence[float], 'mathutils.Matrix'],
...
def triangle_fill(
        bm: 'bmesh.types.BMesh', use_beauty: bool, use_dissolve: bool,
        edges: typing.List['bmesh.types.BMEdge'],
