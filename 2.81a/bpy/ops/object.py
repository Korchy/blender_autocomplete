...
def align(bb_quality: bool = True,
          ...
          align_axis: typing.Set[typing.Union[int, str]] = {}):
    '''Align Objects 
    ...
    :type align_axis: typing.Set[typing.Union[int, str]]
    '''
...
def bake(type: typing.Union[int, str] = 'COMBINED',
         pass_filter: typing.Set[typing.Union[int, str]] = {},
         filepath: str = "",
         width: int = 512,
         height: int = 512,
         margin: int = 16,
    ...
    :type pass_filter: typing.Set[typing.Union[int, str]]
...
def make_override_library(object: typing.Union[int, str] = 'DEFAULT'):
...
def mode_set_with_submode(
        ...
        toggle: bool = False,
        mesh_select_mode: typing.Set[typing.Union[int, str]] = {}):
    '''Sets the object interaction mode 
    ...
    :type mesh_select_mode: typing.Set[typing.Union[int, str]]
    '''
...
def modifier_apply(apply_as: typing.Union[int, str] = 'DATA',
                   modifier: str = ""):
    '''Apply modifier and remove from the stack 
...
def quick_fluid(style: typing.Union[int, str] = 'BASIC',
