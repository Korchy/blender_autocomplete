...
def collada_export(
        ...
        display_type: int = 'DEFAULT',
        sort_method: int = 'FILE_SORT_ALPHA',
        prop_bc_export_ui_section: int = 'main',
        apply_modifiers: bool = False,
        export_mesh_type: int = 0,
        export_mesh_type_selection: int = 'view',
        export_global_forward_selection: int = 'Y',
        export_global_up_selection: int = 'Z',
        ...
        export_animation_type_selection: int = 'sample',
        sampling_rate: int = 1,
        ...
        export_object_transformation_type_selection: int = 'matrix',
        export_animation_transformation_type: int = 0,
        export_animation_transformation_type_selection: int = 'matrix',
        open_sim: bool = False,
    ...
    :type prop_bc_export_ui_section: int
    ...
    :type export_global_forward_selection: int
    ...
    :type export_global_up_selection: int
    ...
    :type export_animation_type_selection: int
    ...
    :type export_object_transformation_type_selection: int
    ...
    :type export_animation_transformation_type_selection: int
...
def read_factory_settings(app_template="Template", use_empty: bool = False):
    '''Load default file and preferences 
