...
def cursor3d(use_depth: bool = True, orientation: int = 'VIEW'):
...
def toggle_shading(type: int = 'WIREFRAME'):
...
def transform_gizmo_set(extend: bool = False, type: typing.Set[int] = {}):
