...
def gltf(export_format: int = 'GLB',
         ui_tab: int = 'GENERAL',
         export_copyright: str = "",
         export_image_format: int = 'NAME',
         ...
         export_force_sampling: bool = False,
    ...
    :param export_apply: Apply Modifiers, Apply modifiers (excluding Armatures) to mesh objects 
