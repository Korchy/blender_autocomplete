...
def BoolVectorProperty(name: str = "",
                       ...
                       update=None,
                       get=None,
                       set=None) -> typing.List['bpy.types.BoolProperty']:
    ...
    :param get: Function to be called when this value is 'read', This function must take 1 value (self) and return the value of the property.
    :param set: Function to be called when this value is 'written', This function must take 2 values (self, value) and return None.
    :rtype: typing.List['bpy.types.BoolProperty']
    '''
...
def CollectionProperty(type=None,
                       ...
                       options: set = {'ANIMATABLE'},
                       override: set = 'set()',
                       tags: set = 'set()') -> 'bpy.types.CollectionProperty':
...
def FloatVectorProperty(name: str = "",
                        ...
                        subtype: str = 'NONE',
                        unit: str = 'NONE',
                        size: typing.Union[int, typing.List[int]] = 3,
                        update=None,
                        get=None,
                        set=None) -> typing.List['bpy.types.FloatProperty']:
    ...
    :param get: Function to be called when this value is 'read', This function must take 1 value (self) and return the value of the property.
    :param set: Function to be called when this value is 'written', This function must take 2 values (self, value) and return None.
    :rtype: typing.List['bpy.types.FloatProperty']
    '''
...
def IntVectorProperty(name: str = "",
                      ...
                      update=None,
                      get=None,
                      set=None) -> typing.List['bpy.types.IntProperty']:
    ...
    :param get: Function to be called when this value is 'read', This function must take 1 value (self) and return the value of the property.
    :param set: Function to be called when this value is 'written', This function must take 2 values (self, value) and return None.
    :rtype: typing.List['bpy.types.IntProperty']
    '''
