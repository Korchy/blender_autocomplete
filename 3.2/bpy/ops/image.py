...
def flip(use_flip_x: bool = False, use_flip_y: bool = False):
    ''' Flip the image
...
def open(allow_path_tokens: bool = True,
         filepath: str = "",
         directory: str = "",
         files: typing.
...
def project_apply():
    ''' Project edited image back onto the object :file: startup/bl_operators/image.py\:180 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/image.py$180> _
...
def project_edit():
    ''' Edit a snapshot of the 3D Viewport in an external image editor :file: startup/bl_operators/image.py\:110 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/image.py$110> _
...
def view_cursor_center(fit_view: bool = False):
