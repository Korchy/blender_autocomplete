...
def bundle_install(asset_library_ref: typing.Union[str, int] = '',
                   filepath: str = "",
...
def open_containing_blend_file():
    ''' Open the blend file that contains the active asset :file: startup/bl_operators/assets.py\:95 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/assets.py$95> _
...
def tag_add():
    ''' Add a new keyword tag to the active asset :file: startup/bl_operators/assets.py\:36 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/assets.py$36> _
...
def tag_remove():
    ''' Remove an existing keyword tag from the active asset :file: startup/bl_operators/assets.py\:59 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/assets.py$59> _
