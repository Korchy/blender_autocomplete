...
def layer_duplicate_object(mode: typing.Union[str, int] = 'ALL',
...
def layer_mask_move(type: typing.Union[str, int] = 'UP'):
...
def layer_merge(mode: typing.Union[str, int] = 'ACTIVE'):
    ''' Combine Layers
...
def segment_move(modifier: str = "", type: typing.Union[str, int] = 'UP'):
...
def stroke_normalize(mode: typing.Union[str, int] = 'THICKNESS',
                     factor: float = 1.0,
                     value: int = 10):
...
def stroke_smooth(repeat: int = 2,
                  factor: float = 1.0,
...
def tint_flip():
    ''' Switch tint colors :file: startup/bl_ui/properties_grease_pencil_common.py\:883 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_ui/properties_grease_pencil_common.py$883> _
