...
def cloth_filter(type: typing.Union[str, int] = 'GRAVITY',
    ...
    :type force_axis: typing.Union[typing.Set[str], typing.Set[int]]
...
def expand(target: typing.Union[str, int] = 'MASK',
           falloff_type: typing.Union[str, int] = 'GEODESIC',
           invert: bool = False,
           use_mask_preserve: bool = False,
           use_falloff_gradient: bool = False,
           use_modify_active: bool = False,
           use_reposition_pivot: bool = True,
           max_geodesic_move_preview: int = 10000):
    ...
    :type falloff_type: typing.Union[str, int]
...
def mask_filter(filter_type: typing.Union[str, int] = 'SMOOTH',
                iterations: int = 1,
                auto_iteration_count: bool = True):
...
def mask_init(mode: typing.Union[str, int] = 'RANDOM_PER_VERTEX'):
...
def trim_box_gesture(xmin: int = 0,
    ...
    :type trim_mode: typing.Union[str, int]
    ...
    :type trim_orientation: typing.Union[str, int]
    '''
