...
def blend_to_default(factor: float = 0.333333):
...
def blend_to_neighbor(factor: float = 0.333333):
...
def breakdown(factor: float = 0.333333):
...
def equalize_handles(side: typing.Union[str, int] = 'LEFT',
