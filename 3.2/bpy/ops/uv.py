...
def pack_islands(udim_source: typing.Union[str, int] = 'CLOSEST_UDIM',
                 rotate: bool = True,
                 margin: float = 0.001):
...
def select_mode(type: typing.Union[str, int] = 'VERTEX'):
    ''' Change UV selection mode

    :param type: Type * VERTEX Vertex -- Vertex selection mode. * EDGE Edge -- Edge selection mode. * FACE Face -- Face selection mode. * ISLAND Island -- Island selection mode.
