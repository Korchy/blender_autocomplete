...
def select_next_item():
    ''' Select the next element (using selection order) :file: startup/bl_operators/mesh.py\:196 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/mesh.py$196> _
...
def select_prev_item():
    ''' Select the previous element (using selection order) :file: startup/bl_operators/mesh.py\:221 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/mesh.py$221> _
