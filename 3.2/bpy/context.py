...
active_file: 'bpy.types.FileSelectEntry' = None

active_gpencil_frame: list = None

active_gpencil_layer: typing.List['bpy.types.GPencilLayer'] = None

active_nla_strip: 'bpy.types.NlaStrip' = None

active_nla_track: 'bpy.types.NlaTrack' = None
...
active_sequence_strip: 'bpy.types.Sequence' = None
...
asset_file_handle: 'bpy.types.FileSelectEntry' = None
''' The file of an active asset. Avoid using this, it will be replaced by a proper AssetHandle design
'''

asset_library_ref: 'bpy.types.AssetLibraryReference' = None
...
selected_asset_files: typing.List['bpy.types.FileSelectEntry'] = None

selected_bones: typing.List['bpy.types.EditBone'] = None

selected_editable_actions: typing.List['bpy.types.Action'] = None
...
selected_files: typing.List['bpy.types.FileSelectEntry'] = None

selected_ids: typing.List['bpy.types.ID'] = None

selected_movieclip_tracks: typing.List['bpy.types.MovieTrackingTrack'] = None
...
selected_visible_actions: typing.List['bpy.types.Action'] = None
...
texture_slot: 'bpy.types.TextureSlot' = None
