...
def flip(use_flip_horizontal: bool = False, use_flip_vertical: bool = False):
    ''' Flip the image

    :param use_flip_horizontal: Horizontal, Flip the image horizontally
    :type use_flip_horizontal: bool
    :param use_flip_vertical: Vertical, Flip the image vertically
    :type use_flip_vertical: bool
    '''
