...
def active_preview_toggle():
    ''' Toggle active preview state of node :file: startup/bl_operators/node.py\:326 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/node.py$326> _
...
def add_object(name: str = "Object"):
...
def add_texture(name: str = "Texture"):
...
def copy_geometry_node_group_assign():
    ''' Copy the active geometry node group and assign it to the active modifier :file: startup/bl_operators/geometry_nodes.py\:106 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/geometry_nodes.py$106> _
