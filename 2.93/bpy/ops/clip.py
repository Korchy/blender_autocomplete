...
def constraint_to_fcurve():
    ''' Create F-Curves for object which will copy object's movement caused by this constraint :file: startup/bl_operators/clip.py\:544 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$544> _
...
def set_viewport_background():
    ''' Set current movie clip as a camera background in 3D Viewport (works only when a 3D Viewport is visible) :file: startup/bl_operators/clip.py\:434 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$434> _
...
def setup_tracking_scene():
    ''' Prepare scene for compositing 3D objects into this footage :file: startup/bl_operators/clip.py\:998 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$998> _
...
def track_settings_as_default():
    ''' Copy tracking settings from active track to default settings :file: startup/bl_operators/clip.py\:1029 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$1029> _
...
def track_settings_to_track():
    ''' Copy tracking settings from active track to selected tracks :file: startup/bl_operators/clip.py\:1077 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/clip.py$1077> _
