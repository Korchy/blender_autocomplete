...
def gpencil_add(radius: float = 1.0,
    ...
    :type type: typing.Union[str, int]
    :param use_in_front: In Front, Show line art grease pencil in front of everything
...
def hair_add(align: typing.Union[str, int] = 'WORLD',
             location: typing.List[float] = (0.0, 0.0, 0.0),
             rotation: typing.List[float] = (0.0, 0.0, 0.0),
             scale: typing.List[float] = (0.0, 0.0, 0.0)):
...
def transfer_mode(use_eyedropper: bool = False):
    ...
    :param use_eyedropper: Use Eyedropper, Pick the object to switch to using an eyedropper
    :type use_eyedropper: bool
    '''
