...
def drop_named_image(name: str = "Image",
                     filepath: str = "Path",
...
def extrude_edges_indiv(mirror: bool = False):
...
def extrude_region(mirror: bool = False):
...
def knife_tool(use_occlude_geometry: bool = True, only_selected: bool = False):
    '''Cut new topology 
...
def select_axis(mode: int = 'POSITIVE',
                axis: int = 'X_AXIS',
                threshold: float = 0.0001):
